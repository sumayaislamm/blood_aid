...
export const createProfile = async (req, res) => {
    try {
        ...
        const profile = await createDonorProfile(req.user.userId, req.body);
...
export const updateMyProfile = async (req, res) => {
    try {
        ...
        const profile = await updateMyDonorProfile(req.user.userId, req.body);
        return res.status(200).json({
            success: true,
...
//# sourceMappingURL=donor-profile.controller.js.map