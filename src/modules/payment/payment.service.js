...
export const createPayment = async (requesterId, data) => {
    ...
    if (!bloodRequest) {
        throw new Error("Blood request not found or you do not have permission to pay for it");
    }
    ...
    if (existingPayment) {
        throw new Error("An active payment already exists for this blood request");
    }
            ...
            line_items: [
                {
                    price_data: {
                        ...
                        unit_amount: Math.round(Number(bloodRequest.amount) * 100),
                    },
                    quantity: 1,
                },
            ],
