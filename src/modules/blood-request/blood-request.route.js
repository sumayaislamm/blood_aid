...
import { createBloodRequestSchema, updateBloodRequestSchema, } from "./blood-request.validation";
const router = Router();
router.post("/", authenticate, authorize("REQUESTER"), validate(createBloodRequestSchema), createRequest);
...
router.patch("/:id", authenticate, authorize("REQUESTER"), validate(updateBloodRequestSchema), updateRequest);
